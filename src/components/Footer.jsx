        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4 rtl:space-x-reverse">
              <a href="#" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition-all duration-300 hover-lift">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service, index) => (
                <li key={index} className="text-purple-100 hover:text-white transition-colors duration-300">
                  {service}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <Phone className="w-5 h-5 text-green-400" />
                <p className="text-purple-100" dir="ltr">+966 11 123 4567</p>
              </div>
