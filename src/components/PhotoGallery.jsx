...
const PhotoGallery = ({ images = [], title = "معرض صور حضانتنا", subtitle = "اكتشف بيئة التعلم الآمنة والمحفزة التي نوفرها لأطفالكم الأعزاء" }) => {
  ...
  const defaultGalleryData = [
    {
      id: 1,
      src: './src/assets/istockphoto-1436184172-612x612.jpg',
    ...
    {
      id: 2,
      src: './src/assets/istockphoto-2160438108-612x612.jpg',
    ...
    {
      id: 3,
      src: './src/assets/istockphoto-1468140092-612x612.jpg',
    ...
    {
      id: 5,
      src: './src/assets/pexels-max-fischer-5212695.jpg',
    ...
    {
      id: 6,
      src: './src/assets/pexels-rdne-8363570.jpg',
      alt: 'أطفال في الفصل',
      category: 'classroom',
      title: 'بيئة التعلم'
    },
    {
      id: 7,
      src: './src/assets/pexels-pavel-danilyuk-8422110.jpg',
      alt: 'غرفة اللعب',
      category: 'playroom',
      title: 'غرفة اللعب'
    },
    {
      id: 8,
      src: './src/assets/pexels-kampus-8941650.jpg',
