...
const FAQ = () => {
  ...
  return (
    <section
      className="py-16 px-4 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen"
      dir="rtl"
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 text-center bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-[#149c8c] bg-white text-black px-8 py-3 rounded-lg font-semibold hover:bg-[#072838] hover:text-white transition-all duration-300 shadow-lg hover:shadow-xl border border-black">
              اتصل بنا
            </button>

            <button className="border-2 text-white bg-[#149c8c] px-8 py-3 rounded-lg font-semibold hover:bg-[#072838] hover:text-white transition-all duration-300">
              احجز زيارة
            </button>
          </div>
        </div>
