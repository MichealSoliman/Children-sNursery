...
const HomeLearningSection = () => {
  ...
  const learningCards = [
    {
      ...
      description: "تعلم كيفية التواصل الفعال مع طفلك وبناء بيئة محفزة للتعلم في المنزل",
    ...
    },
    {
      ...
      description: "طرق مبتكرة وممتعة لتعليم المواد الأساسية كالقراءة والكتابة والرياضيات",
      image: studySpaceImg,
      icon: BookOpen,
    ...
    },
    {
      ...
      description: "كيفية متابعة تقدم طفلك وتقييم مستواه التعليمي بطريقة إيجابية ومحفزة",
  ...
  const quickTips = [
    { icon: Lightbulb, text: "اجعل وقت التعلم ممتعاً", color: "text-yellow-500" },
    { icon: Star, text: "احتفل بكل إنجاز", color: "text-purple-500" },
    { icon: Users, text: "شارك في أنشطة جماعية", color: "text-blue-500" },
    { icon: Award, text: "كافئ الجهد وليس النتيجة فقط", color: "text-green-500" }
  ];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="flex items-center justify-center mb-6">
            <div className="bg-[#023047] p-4 rounded-full shadow-lg">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            نساعدك في بناء بيئة تعليمية محفزة في المنزل، مع أدوات وطرق مبتكرة لمتابعة تقدم طفلك 
            بعد انتهاء فترة الحضانة وضمان استمرار نموه التعليمي والشخصي
          </p>
        </motion.div>
            ...
            >
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden transform transition-all duration-500 group-hover:scale-105 group-hover:shadow-2xl">
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  />
                  <div className={`absolute inset-0 bg-gradient-to-t ${card.color} opacity-80`}></div>
                ...
                <div className="p-6">
                  <div className="mb-4">
                    ...
                    <p className="text-sm font-medium text-gray-500 uppercase tracking-wide">{card.subtitle}</p>
                  </div>
                  ...
                  <div className={`space-y-3 transition-all duration-500 ${
                    activeCard === card.id ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                  }`}>
                    {card.tips.map((tip, tipIndex) => (
                      <motion.div
                        key={tipIndex}
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: activeCard === card.id ? 1 : 0, x: activeCard === card.id ? 0 : -20 }}
                  ...
                  {/* Action Button */}
                  <div className="mt-6">
                    <button className={`w-full bg-gradient-to-r ${card.color} text-white py-3 px-6 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg flex items-center justify-center space-x-2 space-x-reverse group`}>
        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-3xl font-bold text-gray-800 mb-4">نصائح سريعة للنجاح</h3>
            <p className="text-gray-600">إرشادات بسيطة لجعل التعلم المنزلي أكثر فعالية ومتعة</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {quickTips.map((tip, index) => (
              ...
              >
                <div className="mb-4">
                  <tip.icon className={`w-12 h-12 ${tip.color} mx-auto transition-transform duration-300 group-hover:scale-110`} />
                </div>
        ...
        >
          <div className="bg-[#023047] rounded-3xl p-8 text-white shadow-2xl">
