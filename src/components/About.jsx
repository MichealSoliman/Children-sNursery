      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-2 rtl:space-x-reverse mb-4">
            <span className="text font-bold font-semibold text-lg">
              تعرف علينا
            </span>
          </div>
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-[#023047] mb-6">
            من نحن؟{" "}
            <span className="text-[#149c8c]">حضانة براعم المستقبل</span>
          </h2>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-6 flex items-center space-x-3 rtl:space-x-reverse">
                <Heart className="w-8 h-8 text-[#149c8c]" />
                <span>رسالتنا</span>
              </h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                في حضانة براعم المستقبل، نؤمن بأن كل طفل هو كنز ثمين يحتاج إلى
                رعاية خاصة وحب لا محدود. نحن ملتزمون بتوفير بيئة تعليمية آمنة
                ومحفزة تساعد الأطفال على النمو والازدهار في جميع جوانب شخصيتهم.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                منذ تأسيسنا قبل 15 عاماً، نفخر بكوننا البيت الثاني لأكثر من 200
                طفل، حيث نقدم لهم أفضل الخدمات التعليمية والترفيهية مع فريق
                متخصص من المربيات المؤهلات.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover-lift">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-4 rtl:space-x-reverse">
                  <div className="w-12 h-12 bg-[#149c8c] rounded-full flex items-center justify-center">
